# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/10_edge_builder.ipynb.

# %% auto 0
__all__ = ['create_edges_json']

# %% ../../../nbs/10_edge_builder.ipynb 2
import numpy as np
from nbdev_testing_simon2.node_builder import find_node_by_det
