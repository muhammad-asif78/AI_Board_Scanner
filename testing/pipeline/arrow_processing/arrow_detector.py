# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/07_arrow_detector.ipynb.

# %% auto 0
__all__ = ['crop_image_region', 'convert_to_binary_mask', 'find_arrow_endpoints']

# %% ../../../nbs/07_arrow_detector.ipynb 2
import math
import cv2
import numpy as np
from nbdev_testing_simon2.skeleton_analyzer import extract_skeleton, skeleton_has_cycle, find_best_arrow_by_straightness
from nbdev_testing_simon2.diamond_handler import dilate_ocr_regions, find_skeleton_points_on_bbox
from nbdev_testing_simon2.geometry_utils import check_bbox_intersection, find_farthest_points_euclidean
...
def find_arrow_endpoints(image_bgr, detections, ocr_results):
    ...
    def _interpolate_dashed(mask):
        ...
        dash_endpoints = []
        for cnt in contours:
            ep = find_farthest_points_euclidean(cnt)
            if ep:
