# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/04_sam2_processor.ipynb.

# %% auto 0
__all__ = ['predict_angles_with_masks']

# %% ../../../nbs/04_sam2_processor.ipynb 2
import os
from typing import List, Dict, Any
import numpy as np
import cv2
from nbdev_testing_simon2.angle_predictor import _load_angle_models, _get_angle_transform, _TORCH_AVAILABLE
...
def predict_angles_with_masks(image_bgr, detections):
    ...
    for i, det in enumerate(filtered):
        ...
        if label == 'Pentagon':
            ...
            from nbdev_testing_simon2.angle_predictor import _ANGLE_NUM_CLASSES
