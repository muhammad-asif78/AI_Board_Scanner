# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_color_extractor.ipynb.

# %% auto 0
__all__ = ['find_dominant_color_masked', 'rgb_to_hex', 'get_corner_background_color', 'extract_shape_mask', 'find_dominant_color',
           'attach_colors']

# %% ../../nbs/02_color_extractor.ipynb 2
import cv2
import numpy as np
