# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01_geometry_utils.ipynb.

# %% auto 0
__all__ = ['check_bbox_intersection', 'nearest_point_on_bbox', 'find_nearest_shape_bbox', 'find_farthest_points_in_contour',
           'find_farthest_points_euclidean', 'establish_connections']

# %% ../../nbs/01_geometry_utils.ipynb 2
import math
import cv2
import numpy as np
