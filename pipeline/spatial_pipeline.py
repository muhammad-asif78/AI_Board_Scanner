# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/14_spatial_pipeline.ipynb.

# %% auto 0
__all__ = ['ANGLE_ALLOWED_SHAPES', 'run_spatial_mapping']

# %% ../nbs/14_spatial_pipeline.ipynb 2
...
from .angle_detection.angle_predictor import predict_angles
from .angle_detection.sam2_processor import predict_angles_with_masks
from .arrow_processing.arrow_detector import find_arrow_endpoints
from .shape_processing.color_extractor import attach_colors
from .shape_processing.geometry_utils import establish_connections
from .ocr_processing.text_mapper import map_ocr_to_nodes, get_text_rotation_for_shape
from .json_builders.node_builder import create_nodes_json, attach_angles_to_nodes
from .json_builders.edge_builder import create_edges_json
...
def run_spatial_mapping(file_path: str) -> Dict[str, Any]:
    ...
    detections = detect_shapes(img_path, raise_on_model_failure=True)
