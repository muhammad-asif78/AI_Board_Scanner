...
[source](https://github.com/muhammad-asif78/nbdev_testing_simon2/blob/main/pipeline/ocr_processing/text_mapper.py#L80){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/muhammad-asif78/nbdev_testing_simon2/blob/main/pipeline/ocr_processing/text_mapper.py#L23){target="_blank" style="float:right; font-size:smaller"}
